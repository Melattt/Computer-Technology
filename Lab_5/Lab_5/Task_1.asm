...
;
; Function: A program in Assembly that displays the character %. Look in the data sheet how to initiate 
;			the display. You will find a data sheet for the display on the course site. The display will be 
;			connected as in the figure above. 4-bit-mode should be used, since only RS, E, D7, D6, D5 and D4 
;			are connected to I/O-pins on the STK600.
;
; Input ports: none
;
